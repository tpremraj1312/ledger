...
// Ensure a user has only one budget entry per unique category + period + month + year + type combination
budgetSchema.index({ user: 1, category: 1, month: 1, year: 1, period: 1, type: 1 }, { unique: true });
