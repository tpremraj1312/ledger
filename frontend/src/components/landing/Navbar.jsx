...
const Navbar = () => {
    ...
    return (
        <motion.nav
            ...
            className="fixed top-0 left-0 w-full z-50 px-4 sm:px-6 py-4 pointer-events-none"
        >
            <div className="container mx-auto pointer-events-auto relative">
                <div className="flex items-center justify-between glass-panel px-6 py-3 rounded-2xl border border-slate-200/50 shadow-sm bg-white/70 backdrop-blur-md">
