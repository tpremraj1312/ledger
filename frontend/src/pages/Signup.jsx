      ...
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md space-y-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className={`w-full bg-purple-600 text-white font-semibold py-3 rounded-lg transition duration-200 ${isSubmitting ? "opacity-50 cursor-not-allowed" : "hover:bg-purple-700"
              }`}
          >
